        ...
        if ($request->ajax()) {
            ...
            if (isset($response['finish_reason'])) {
                if ($response['finish_reason'] == 'SUCCESS' || $response['finish_reason'] == 'CONTENT_FILTERED') {
                    ...
                    $content->vendor = 'sd';
                    $content->vendor_engine = 'photo_studio';
                    ...
                    $cost = 1;
                    switch ($request->task) {
                        case 'reimagine': $cost = $studio->sd_photo_studio_reimagine; break;
                        case 'structure': $cost = $studio->sd_photo_studio_structure; break;
                        case 'sketch': $cost = $studio->sd_photo_studio_sketch; break;
                        case 'erase': $cost = $studio->sd_photo_studio_erase_object; break;
                        case 'inpaint': $cost = $studio->sd_photo_studio_inpaint; break;
                        case 'replace': $cost = $studio->sd_photo_studio_search_replace; break;
                        case 'background': $cost = $studio->sd_photo_studio_remove_background; break;
                        case 'outpaint': $cost = $studio->sd_photo_studio_outpaint; break;
                        case 'upscale_conservative': $cost = $studio->sd_photo_studio_conservative_upscaler; break;
                        case 'upscale_creative': $cost = $studio->sd_photo_studio_creative_upscaler; break;
                        case 'text': $cost = $studio->sd_photo_studio_text; break;
                        default: $cost = 1;
                    }
