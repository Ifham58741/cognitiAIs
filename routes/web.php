...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['localeSessionRedirect', 'localizationRedirect', 'localeViewPath']], function () {
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['verified', '2fa.verify', 'role:admin', 'PreventBackHistory']], function() {
        ...
        Route::controller(DavinciConfigController::class)->group(function() {
            ...
            Route::get('/davinci/configs/sd', 'showPhotoStudio')->name('admin.davinci.configs.sd');
            Route::post('/davinci/configs/sd/store', 'storePhotoStudio')->name('admin.davinci.configs.sd.store');
        ...
        Route::controller(ElseyyidController::class)->group(function() {
            Route::get('/settings/languages/home', 'index')->name('elseyyid.translations.home');
            Route::get('/settings/languages/lang/{lang}', 'lang')->name('elseyyid.translations.lang');
            Route::get('/settings/languages/lang/generateJson/{lang}', 'generateJson')->name('elseyyid.translations.lang.generateJson');
            Route::get('/settings/languages/newLang', 'newLang')->name('elseyyid.translations.lang.newLang');
            Route::get('/settings/languages/newString', 'newString')->name('elseyyid.translations.lang.newString');
            Route::get('/settings/languages/search', 'search')->name('elseyyid.translations.lang.search');
            Route::get('/settings/languages/publish-all', 'publishAll')->name('elseyyid.translations.lang.publishAll');
           // Route::post('/settings/languages/lang/update/{id}', 'update')->name('elseyyid.translations.lang.update');
        });

        Route::post('/settings/languages/lang/update-all', [LanguageController::class, 'languagesUpdateAll'])->name('elseyyid.translations.lang.update-all');
        Route::post('/settings/languages/lang/save', [LanguageController::class, 'languageSave'])->name('elseyyid.translations.lang.lang-save');
        ...
        Route::get('/settings/languages/setLocale', function (\Illuminate\Http\Request $request) {
            ...
            return redirect()->route('elseyyid.translations.home', [$request->setLocale]);
        })->name('elseyyid.translations.lang.setLocale');
        ...
        Route::get('/settings/languages/regenerate', function () {
            ...
            return redirect()->route('elseyyid.translations.home');
    ...
    Route::group(['prefix' => 'user', 'middleware' => ['verified', '2fa.verify', 'role:user|admin|subscriber', 'subscription.check', 'PreventBackHistory']], function() {
        ...
        Route::controller(IntegrationController::class)->group(function () {
            ...
            Route::get('/integration/{id}/edit', 'edit')->name('user.integration.edit');  
            Route::put('/integration/{id}/update', 'update')->name('user.integration.update');                  
        });
        ...
        Route::controller(DocumentController::class)->group(function() { 
            ...
            Route::get('/document/{id}/publish', 'publish')->name('user.documents.publish');
            Route::post('/document/publish', 'publishWordpress')->name('user.documents.publish.wordpress');
        });
